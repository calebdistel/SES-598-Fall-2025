...
MODEL                   = ddc_simulink_CRD_fixed
MODULES                 = ddc_simulink_CRD_fixed.c ddc_simulink_CRD_fixed_capi.c ddc_simulink_CRD_fixed_data.c ddc_simulink_CRD_fixed_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = ddc_simulink_CRD_fixed.exe
MAKEFILE                = ddc_simulink_CRD_fixed.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2022b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2022b
START_DIR               = C:\Users\caleb\Documents\GitHub\SES-598-Fall-2025\DISTEL_HW12_11172025
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ddc_simulink_CRD_fixed_ref.rsp
COMPILER_COMMAND_FILE     = ddc_simulink_CRD_fixed_comp.rsp
