...
HD_PWD='C:/Users/caleb/Documents/GitHub/SES-598-Fall-2025/DISTEL_HW13_11302025/hdl_prj/vivado_prj/ddc_spec_avg_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddc_spec_avg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddc_spec_avg.tcl
