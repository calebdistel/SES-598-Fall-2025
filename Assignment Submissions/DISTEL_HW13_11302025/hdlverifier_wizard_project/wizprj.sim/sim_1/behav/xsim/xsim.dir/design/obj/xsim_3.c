...
{
	iki_sensitize(dp, "xsim.dir/design/xsim.reloc");
}
...
{
		iki_schedule_processes_at_time_zero(dp, "xsim.dir/design/xsim.reloc");
...
{
    int argc = 2;
    char* argv[7] = {"xsim.dir/design/xsimk.dll", "-nolog"};
    if (setup_info->logFileName) {
        argc = 3;
        argv[1] = "-log";
        argv[2] = setup_info->logFileName;
    }
   if (setup_info->xsimDir) {
        argv[argc] = "-xsimdir";
        ++argc;
        argv[argc] = (setup_info->xsimDir) ? setup_info->xsimDir  : "";
        ++argc;
    }
    iki_heap_initialize("ms", "isimmm", 0, 2147483648) ;
    iki_set_xsimdir_location_if_remapped(argc, argv)  ;
    iki_set_sv_type_file_path_name("xsim.dir/design/xsim.svtype");
    iki_set_crvs_dump_file_path_name("xsim.dir/design/xsim.crvsdump");
    void* design_handle = iki_create_design("xsim.dir/design/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, (void*)0, 0, 0, 1, argc, argv);
