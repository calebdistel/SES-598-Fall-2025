-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ddc_simulink_CRD_fixed\LookUpTableGen.vhd
...
-- Source Path: ddc_simulink_CRD_fixed/Chirp/NCO1/WaveformGen/LookUpTableGen
-- Hierarchy Level: 4
-- 
...
ARCHITECTURE rtl OF LookUpTableGen IS
  ...
  SIGNAL Lookup_Table_k                   : unsigned(10 DOWNTO 0);  -- ufix11
...
BEGIN
  ...
  Lookup_Table_k <= to_unsigned(16#000#, 11) WHEN lutaddrInReg = to_unsigned(16#000#, 11) ELSE
